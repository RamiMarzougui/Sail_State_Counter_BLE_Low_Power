...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x655B, 0x455B, 0x0000, 0x0CA2, 0x0001, 0x0CA3, 0x14BA, 0x047F, 0x5657, 0x665B, 0x465B, 0x0000, 0x0CA2, 0x0002, 0x0CA3, 0x1416, 
    ...
    /*0x0140*/ 0x00B9, 0x0117, 0x0000, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 
    /*0x0160*/ 0x0000, 0x0000, 0x0000, 0x0015, 0x8B56, 0x655B, 0x7656, 0x455B, 0xADB7, 0xADB7, 0x0015, 0x8B3A, 0x773A, 0x0000, 0x0CB2, 0x86C3, 
    /*0x0180*/ 0x0350, 0x8801, 0x8B49, 0x8DB1, 0x86C3, 0x0350, 0x8801, 0x8B49, 0x8DB1, 0x86C3, 0x0350, 0x8801, 0x8B49, 0x8DB1, 0x86C3, 0x0350, 
    /*0x01A0*/ 0x8801, 0x8B49, 0x8DB1, 0x86C3, 0x0350, 0x8801, 0x8B49, 0x8DB1, 0x86C3, 0x0350, 0x8801, 0x8B49, 0x8DB1, 0x86C3, 0x0350, 0x8801, 
    /*0x01C0*/ 0x8B49, 0x8DB1, 0x86C3, 0x0350, 0x8801, 0x8B49, 0x8DB1, 0xFB3B, 0xFD47, 0x893B, 0x8801, 0x0CB2, 0x573A, 0x08B2, 0x8A03, 0xBE03, 
    /*0x01E0*/ 0x08A4, 0x8201, 0x0CA4, 0x08B2, 0x8A04, 0xBE0C, 0x08B0, 0x8AFF, 0xAE06, 0x0000, 0x0CB0, 0x08B1, 0x8801, 0x0CB1, 0x0502, 0x08B0, 
    /*0x0200*/ 0x8801, 0x0CB0, 0x08B2, 0x8A05, 0xBE0C, 0x08AE, 0x8AFF, 0xAE06, 0x0000, 0x0CAE, 0x08AF, 0x8801, 0x0CAF, 0x0511, 0x08AE, 0x8801, 
    /*0x0220*/ 0x0CAE, 0x0015, 0x8B56, 0x655B, 0x7656, 0x455B, 0xADB7, 0x5656, 0x655B, 0x455B, 0xADB7
};


/// Look-up table that converts from AUX I/O index to MCU IOCFG offset
static const uint8_t pAuxIoIndexToMcuIocfgOffsetLut[] = {
    124, 68, 64, 60, 56, 52, 48, 44, 40, 36, 32, 28, 24, 20, 16, 12, 8, 4, 0, 120, 116, 112, 108, 104, 100, 96, 92, 88, 84, 80, 76, 72
};
...
//  cfg         input       output      state       
    0x00000000, 0x00000000, 0x0040115C, 0x00101164  // Count
};
...
static void scifDriverSetupInit(void) {
    ...
    scifInitIo(21, AUXIOMODE_INPUT, 0, 0);
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_COUNT_TASK_ID)) {
        scifReinitIo(21, 0, 0);
    }
} // scifReinitTaskIo
