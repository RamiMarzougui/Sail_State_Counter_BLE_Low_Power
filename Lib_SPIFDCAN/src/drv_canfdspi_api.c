...
Ecode_t DRV_CANFDSPI_Reset(CANFDSPI_MODULE_ID index, SPI_Handle controllerSpi)
{
    ...
    DRV_SPI_Transfer(controllerSpi, spiTransmitBuffer, spiReceiveBuffer, spiTransferSize);
...
Ecode_t DRV_CANFDSPI_ReadByte(CANFDSPI_MODULE_ID index, uint16_t address, uint8_t *rxd, SPI_Handle controllerSpi)
{
...
Ecode_t DRV_CANFDSPI_WriteByte(CANFDSPI_MODULE_ID index, uint16_t address, uint8_t txd, SPI_Handle controllerSpi)
{
    uint16_t spiTransferSize = 3;
    Ecode_t spiTransferError;
    transfer_complete = false;
...
Ecode_t DRV_CANFDSPI_ReadHalfWord(CANFDSPI_MODULE_ID index, uint16_t address, uint16_t *rxd)
{
    uint8_t i;
    uint32_t x;
...
{
    uint8_t d = 0;
    Ecode_t spiTransferError = 0;

    // Read
    DRV_CANFDSPI_ReadByte(index, cREGADDR_CiCON + 3, &d, controllerSpi);
    ...
    // Write
   DRV_CANFDSPI_WriteByte(index, cREGADDR_CiCON + 3, d, controllerSpi);
...
CAN_OPERATION_MODE DRV_CANFDSPI_OperationModeGet(CANFDSPI_MODULE_ID index)
{
    ...
    // Read Opmode
    DRV_CANFDSPI_ReadByte(index, cREGADDR_CiCON + 2, &d, controllerSpi);
...
int8_t DRV_CANFDSPI_LowPowerModeEnable(CANFDSPI_MODULE_ID index)
{
...
#else
    // Read
    DRV_CANFDSPI_ReadByte(index, cREGADDR_OSC, &d, controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, cREGADDR_OSC, d, controllerSpi);
        ...
        CAN_FIFO_CHANNEL channel)
{
    ...
    // Write
    spiTransferError = DRV_CANFDSPI_WriteByte(index, a, d, controllerSpi);
        ...
        CAN_FIFO_CHANNEL channel, bool flush)
{
    ...
    spiTransferError = DRV_CANFDSPI_WriteByte(index, a, ciFifoCon.byte[1], controllerSpi);
        ...
        CAN_FILTER filter, CAN_FIFO_CHANNEL channel, bool enable)
{
    ...
    spiTransferError = DRV_CANFDSPI_WriteByte(index, a, fCtrl.byte, controllerSpi);
...
int8_t DRV_CANFDSPI_FilterEnable(CANFDSPI_MODULE_ID index, CAN_FILTER filter)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &fCtrl.byte, controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, fCtrl.byte, controllerSpi);
        ...
        CAN_DNET_FILTER_SIZE dnfc)
{
    ...
    // Read CiCON byte 0
    DRV_CANFDSPI_ReadByte(index, cREGADDR_CiCON, &d, controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, cREGADDR_CiCON, d, controllerSpi);
        ...
        CAN_FIFO_CHANNEL channel, CAN_RX_FIFO_STATUS* status)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &ciFifoSta.byte[0], controllerSpi);
        ...
        uint8_t *rxd, uint8_t nBytes)
{
    ...
    DRV_CANFDSPI_ReadByteArray(index, a, ba, n);
    ...
    // UINC channel
    DRV_CANFDSPI_ReceiveChannelUpdate(index, channel);
        ...
        CAN_TEF_FIFO_STATUS* status)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &ciTefSta.byte[0], controllerSpi);
...
int8_t DRV_CANFDSPI_TefReset(CANFDSPI_MODULE_ID index)
{
    ...
    // Write byte
    spiTransferError = DRV_CANFDSPI_WriteByte(index, a, ciTefCon.byte[1], controllerSpi);
        ...
        CAN_RXCODE* rxCode)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &rxCodeByte, controllerSpi);
        ...
        CAN_TXCODE* txCode)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &txCodeByte, controllerSpi);
        ...
        CAN_FILTER* filterHit)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &filterHitByte, controllerSpi);
        ...
        CAN_ICODE* icode)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &icodeByte, controllerSpi);
        ...
        CAN_FIFO_CHANNEL channel, CAN_TX_FIFO_EVENT flags)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &ciFifoCon.byte[0], controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, ciFifoCon.byte[0], controllerSpi);
        ...
        CAN_FIFO_CHANNEL channel)
{
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, ciFifoSta.byte[0], controllerSpi);
        ...
        CAN_TEF_FIFO_EVENT flags)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &ciTefCon.byte[0], controllerSpi);

    // Modify
    ciTefCon.byte[0] |= (flags & CAN_TEF_FIFO_ALL_EVENTS);

    // Write
    DRV_CANFDSPI_WriteByte(index, a, ciTefCon.byte[0], controllerSpi);
...
int8_t DRV_CANFDSPI_TefEventOverflowClear(CANFDSPI_MODULE_ID index)
{
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, ciTefSta.byte[0], controllerSpi);
        ...
        uint8_t* tec)
{
   ...
   DRV_CANFDSPI_ReadByte(index, a, tec, controllerSpi);
        ...
        uint8_t* rec)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, rec, controllerSpi);
        ...
        CAN_ERROR_STATE* flags)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &f, controllerSpi);
...
int8_t DRV_CANFDSPI_EccEnable(CANFDSPI_MODULE_ID index)
{
    ...
    // Read
    DRV_CANFDSPI_ReadByte(index, cREGADDR_ECCCON, &d, controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, cREGADDR_ECCCON, d, controllerSpi);
        ...
        CAN_ECC_EVENT* flags)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &eccStatus, controllerSpi);
        ...
        uint8_t parity)
{
    ...
    // Write
    spiTransferError = DRV_CANFDSPI_WriteByte(index, cREGADDR_ECCCON + 1, parity, controllerSpi);
        ...
        uint8_t* parity)
{
    ...
    // Read
    DRV_CANFDSPI_ReadByte(index, cREGADDR_ECCCON + 1, parity, controllerSpi);
        ...
        CAN_ECC_EVENT flags)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &eccInterrupts, controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, eccInterrupts, controllerSpi);
        ...
        CAN_ECC_EVENT flags)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &eccStat, controllerSpi);

    // Modify
    eccStat &= ~(flags & CAN_ECC_ALL_EVENTS);

    // Write
    DRV_CANFDSPI_WriteByte(index, a, eccStat, controllerSpi);
        ...
        CAN_CRC_EVENT flags)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &crc, controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, crc, controllerSpi);
...
int8_t DRV_CANFDSPI_TimeStampEnable(CANFDSPI_MODULE_ID index)
{
    ...
    // Read
    spiTransferError = DRV_CANFDSPI_ReadByte(index, cREGADDR_CiTSCON + 2, &d, controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, cREGADDR_CiTSCON + 2, d, controllerSpi);
        ...
        CAN_TS_MODE mode)
{
    ...
    // Read
    DRV_CANFDSPI_ReadByte(index, cREGADDR_CiTSCON + 2, &d, controllerSpi);
        ...
        CAN_OSC_CTRL ctrl)
{
  Ecode_t spiTransferError;
    ...
    // Write
    spiTransferError = DRV_CANFDSPI_WriteByte(index, cREGADDR_OSC, osc.byte[0], controllerSpi);
        ...
        CAN_OSC_STATUS* status)
{
    ...
    // Read
    DRV_CANFDSPI_ReadByte(index, cREGADDR_OSC + 1, &osc.byte[1], controllerSpi);
        ...
        GPIO_PIN_MODE gpio0, GPIO_PIN_MODE gpio1)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &iocon.byte[3], controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, iocon.byte[3], controllerSpi);
        ...
        GPIO_PIN_DIRECTION gpio0, GPIO_PIN_DIRECTION gpio1)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &iocon.byte[0], controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, iocon.byte[0], controllerSpi);
        ...
        GPIO_PIN_POS pos, GPIO_PIN_STATE latch)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &iocon.byte[1], controllerSpi);
    ...
    // Write
    DRV_CANFDSPI_WriteByte(index, a, iocon.byte[1], controllerSpi);
        ...
        GPIO_PIN_POS pos, GPIO_PIN_STATE* state)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &iocon.byte[2], controllerSpi);
        ...
        CAN_FIFO_CHANNEL channel, uint8_t* mi)
{
    ...
    DRV_CANFDSPI_ReadByte(index, a, &b, controllerSpi);
              ...
              int count)
{
    ...
    /* Perform SPI transfer */
     ...
     if (!transferOK) while(1); //Unsuccessful controller SPI transfer
